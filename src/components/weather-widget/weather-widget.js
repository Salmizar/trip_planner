...
const WeatherWidget = ({ isFirstEntry, location, lon, lat }) => {
    ...
    useEffect(() => {
        ...
        //if (location === "Ottawa") { setLocationData(staticAPIData); }
        fetchWeather();
                    ...
                    <div className='weather-widget-now'>
                        <div className='weather-widget-now-container'>
                            ...
                            <div className={'weather-widget-now-container-feels-wind'}>
                                ...
                                wind {Utils.WeatherUtils.convertMPStoKPH(fiveDayForecast.currentWeather.wind.speed)} kph&nbsp;
                                {Utils.WeatherUtils.getWindDirection(fiveDayForecast.currentWeather.wind.deg)}
                            </div>
                        </div>
                    </div>
